...
if((i < len)){
var k = (ks[i]);
var G__904 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),goog.object.get(o,k));
var G__905 = (i + (1));
m = G__904;
i = G__905;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__907 = c;
var G__907__$1 = (((G__907 == null))?null:G__907.prototype);
if((G__907__$1 == null)){
return null;
} else {
return G__907__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__909 = c;
var G__909__$1 = (((G__909 == null))?null:G__909.prototype);
if((G__909__$1 == null)){
return null;
} else {
return G__909__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__912__delegate = function (args){
return reagent.impl.component.as_element.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__912 = function (var_args){
var args = null;
...
return G__912__delegate.call(this,args);};
G__912.cljs$lang$maxFixedArity = 0;
G__912.cljs$lang$applyTo = (function (arglist__914){
var args = cljs.core.seq(arglist__914);
return G__912__delegate(args);
});
G__912.cljs$core$IFn$_invoke$arity$variadic = G__912__delegate;
return G__912;
})()
;})(c,f,_,res))
:res);
...
var G__916 = c;
var G__916__$1 = (((G__916 == null))?null:G__916.constructor);
if((G__916__$1 == null)){
return null;
} else {
return G__916__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__917 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__918 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__918);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__917);
}});
...
var G__919 = key;
var G__919__$1 = (((G__919 instanceof cljs.core.Keyword))?G__919.fqn:null);
switch (G__919__$1) {
...
var c = this;
var G__922_924 = goog.object.get(c,"cljsRatom");
if((G__922_924 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__922_924);
}
...
var renders_925 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_926 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_925));
...
if((cljs.core.count.call(null,renders_925) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_925))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_926)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_926)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__927 = o;
goog.object.set(G__927,cljs.core.name.call(null,k),v);
